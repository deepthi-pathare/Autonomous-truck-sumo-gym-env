...
sim_params['init_steps'] = 4 # Initial SUMO simulation steps before episode starts. At least one to get sumo subscriptions right.
...
sim_params['outside_road_penalty'] = 10
sim_params['lane_change_penalty'] = 1
sim_params['completion_reward'] = 100
